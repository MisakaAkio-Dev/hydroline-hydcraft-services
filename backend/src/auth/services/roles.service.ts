...
export const PERMISSIONS = {
  ...
  AUTH_VIEW_INVITES: 'auth.view.invites',
  AUTH_MANAGE_INVITES: 'auth.manage.invites',
  ...
  COMPANY_VIEW_APPLICATIONS: 'company.admin.applications',
  COMPANY_MANAGE_APPLICATIONS: 'company.admin.applications.manage',

  // 行政系统
  ADMINISTRATION_VIEW_ADMIN: 'administration.admin.view',
  ADMINISTRATION_MANAGE_ADMIN: 'administration.admin.manage',

  // 流程定义管理
  WORKFLOW_VIEW_DEFINITIONS: 'workflow.view.definitions',
  WORKFLOW_MANAGE_DEFINITIONS: 'workflow.manage.definitions',
  TRANSPORTATION_RAILWAY_MANAGE_FEATURED:
    'transportation.railway.manage-featured',
  TRANSPORTATION_RAILWAY_FORCE_REFRESH: 'transportation.railway.force-refresh',
  TRANSPORTATION_RAILWAY_SYSTEM_MANAGE: 'transportation.railway.system.manage',
  TRANSPORTATION_RAILWAY_SYSTEM_CREATE: 'transportation.railway.system.create',
...
const GRANULAR_PERMISSION_KEYS: string[] = [
  ...
  PERMISSIONS.AUTH_VIEW_INVITES,
  PERMISSIONS.AUTH_MANAGE_INVITES,
  ...
  PERMISSIONS.TRANSPORTATION_RAILWAY_MANAGE_FEATURED,
  PERMISSIONS.TRANSPORTATION_RAILWAY_FORCE_REFRESH,
  ...
  PERMISSIONS.COMPANY_MANAGE_APPLICATIONS,
  PERMISSIONS.ADMINISTRATION_VIEW_ADMIN,
  PERMISSIONS.ADMINISTRATION_MANAGE_ADMIN,
