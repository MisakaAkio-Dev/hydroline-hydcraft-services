...
const emit = defineEmits<{
  ...
  (e: 'saved', value: RailwaySystemDetail): void
}>()
...
watch(
  () => [localOpen.value, systemId.value],
  ([open]) => {
    if (!open) return
                          ...
                          >
                            ...
                            >
                              ...
                              <UIcon
                                ...
                                :class="{
                                  'rotate-180':
                                    searchGroupExpanded[group.groupKey],
                                }"
                              />
                            </div>
                          </button>
                          ...
                          >
                            ...
                            >
                              ...
                              <UIcon
                                ...
                                :class="{
                                  'rotate-180':
                                    selectedGroupExpanded[group.groupKey],
                                }"
                              />
                            </div>
                          </button>
