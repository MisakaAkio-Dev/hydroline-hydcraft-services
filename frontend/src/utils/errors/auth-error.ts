const STATIC_TRANSLATIONS: Record<string, string> = {
  ...
  // Transportation / railway station map errors (backend messages are English)
  'stationId and serverId are required': 'stationId 与 serverId 为必填参数',
  'Station not found': '车站不存在',
  'Route not found': '线路不存在',
